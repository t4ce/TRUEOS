...
pub const OP_BP_LIFECYCLE_CHECKPOINT_RESTORE: u32 = 0x160;
...
pub const OP_BP_BIOS_SCHEMA_SNAPSHOT_READ: u32 = 0x178;
...
pub const OP_BP_UI4_SCENE_SKYBOX_REGISTER_KERNEL: u32 = 0xC4;
pub const OP_BP_UI4_SCENE_WRITE_OPAQUE_RGBA8: u32 = 0xC8;
...
pub const OP_BP_INPUT_MIDI_READ_V1: u32 = 0x200;
pub const OP_BP_MIO_SOCKET_POLL_READY: u32 = 0x201;
pub const OP_BP_PLATFORM_WAIT_OBSERVE: u32 = 0x202;
...
pub const OP_BP_UI4_SCENE_SET_DISPLAY_GAMMA_RAMP: u32 = 0x209;
...
pub const OP_BP_ASYNC_FS_TYPED_STAT_START: u32 = 0x170;
pub const OP_BP_ASYNC_FS_TYPED_LIST_DIR_START: u32 = 0x171;
pub const OP_BP_ASYNC_FS_TYPED_WRITE_BEGIN: u32 = 0x172;
pub const OP_BP_FS_TYPED_WRITE_BEGIN: u32 = 0x173;
pub const OP_BP_FS_TYPED_STAT: u32 = 0x174;
pub const OP_BP_FS_TYPED_LIST_DIR: u32 = 0x175;
pub const OP_BP_UI4_SCENE_SET_CURSOR_STEP: u32 = 0x177;
pub const OP_BP_UI4_SCENE_SET_CENTER_SNAPPED_MOUSE: u32 = 0x17C;
...
pub const OP_BP_VGPU_UI4_INDEXED_BATCH_SUBMIT_V2: u32 = 0x14C;
pub const OP_BP_VGPU_RETAINED_MESH_CREATE: u32 = 0x14D;
pub const OP_BP_VGPU_RETAINED_MESH_DESTROY: u32 = 0x14E;
...
pub const OP_BP_LUMEN_TOOL_RESULT_SUBMIT: u32 = 0x151;
