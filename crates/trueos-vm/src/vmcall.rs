...
pub const OP_BP_UI4_SOLARA_PERSISTENT_TEXT_LAYER_REPLACE: u32 = 0xB9;
pub const OP_BP_UI4_SOLARA_PERSISTENT_TEXT_SCENE_DRAW: u32 = 0xBA;
pub const OP_BP_UI4_SOLARA_PERSISTENT_TEXT_SCENE_CLEAR: u32 = 0xBB;
