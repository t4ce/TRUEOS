...
pub const OP_BP_SSH_SHELL_OPEN: u32 = 0xE9;
pub const OP_BP_SSH_SHELL_WRITE: u32 = 0xEA;
pub const OP_BP_SSH_SHELL_READ: u32 = 0xEB;
pub const OP_BP_SSH_SHELL_RESIZE: u32 = 0xEC;
pub const OP_BP_SSH_SHELL_CLOSE: u32 = 0xED;
