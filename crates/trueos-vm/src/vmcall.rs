...
pub const OP_BP_VMEDIA_IMAGE_DECODE_WRITE: u32 = 0x12E;
pub const OP_BP_VMEDIA_IMAGE_DECODE_COMMIT: u32 = 0x12F;
pub const OP_BP_VMEDIA_IMAGE_DECODE_STATUS: u32 = 0x130;
pub const OP_BP_VMEDIA_IMAGE_DECODE_INFO: u32 = 0x131;
pub const OP_BP_VMEDIA_IMAGE_DECODE_READ: u32 = 0x132;
pub const OP_BP_VMEDIA_IMAGE_DECODE_DISCARD: u32 = 0x133;
