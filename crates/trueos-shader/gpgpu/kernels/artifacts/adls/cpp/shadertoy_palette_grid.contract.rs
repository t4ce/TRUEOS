...
// source: crates/trueos-shader/gpgpu/kernels/shadertoy_palette_grid.clcpp
// frontend: Clang C++ for OpenCL -> LLVM bitcode -> llvm-spirv
// backend: Intel IGC through ocloc -spirv_input
// normalized commands: [["$CLANG","--target=spir64","-x","clcpp","-cl-std=CLC++","-Wall","-Wextra","-Werror","-Wdate-time","-cl-kernel-arg-info","-fno-discard-value-names","-fno-exceptions","-fno-rtti","-MMD","-MF","$OUT_DIR/shadertoy_palette_grid.d","-MT","shadertoy_palette_grid.bc","-emit-llvm","-c","shadertoy_palette_grid.clcpp","-o","$OUT_DIR/shadertoy_palette_grid.bc"],["$LLVM_SPIRV","--preserve-ocl-kernel-arg-type-metadata-through-string","$OUT_DIR/shadertoy_palette_grid.bc","-o","$OUT_DIR/shadertoy_palette_grid.spv"],["$OCLOC","compile","-file","$OUT_DIR/shadertoy_palette_grid.spv","-spirv_input","-device","0x4680","-64","-output","shadertoy_palette_grid","-out_dir","$OUT_DIR","-output_no_suffix","-gen_file"],["$OCLOC","validate","-file","$OUT_DIR/shadertoy_palette_grid.bin"]]
