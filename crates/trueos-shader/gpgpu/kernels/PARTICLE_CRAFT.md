...
and pitch. The fixed-cost 640x400 gather expands each logical pixel over its
corresponding destination region, so maximize/restore covers the replacement
frame without multiplying the particle-gather workload by output resolution.
