...
// The first executable in Mesa's combined fragment blob is SIMD8.  The
// pipeline-cache extractor used to name it SIMD16 by position even though the
// GEN assembly says mov(8)/sendc(8).
...
// The second executable is the real SIMD16 program: mov(16)/sendc(16).
