...
/// Declares an async task that can be run by `trueos-executor`. The optional `pool_size` parameter can be used to specify how
...
/// The following restrictions apply:
///
/// * The function must accept exactly 1 parameter, an `trueos_executor::Spawner` handle that it can use to spawn additional tasks.
/// * The function must be declared `async`.
/// * The function must not use generics.
...
///
/// ``` rust
/// #[trueos_executor::main]
/// async fn main(_s: trueos_executor::Spawner) {
///     // Function body
/// }
/// ```
#[proc_macro_attribute]
...
/// The following restrictions apply:
///
/// * The function must accept exactly 1 parameter, an `trueos_executor::Spawner` handle that it
...
/// Spawning a task:
/// ``` rust
/// #[trueos_executor::main(entry = "qingke_rt::entry")]
/// async fn main(_s: trueos_executor::Spawner) {
///     // Function body
/// }
/// ```
...
/// ``` rust
/// #[trueos_executor::main(entry = "esp_riscv_rt::entry")]
/// async fn main(_s: trueos_executor::Spawner) {
///     // Function body
/// }
/// ```
...
/// Spawning a task:
/// ``` rust
/// #[trueos_executor::main(entry = "your_hal::entry", executor = "your_hal::Executor")]
/// async fn main(_s: trueos_executor::Spawner) {
///     // Function body
/// }
/// ```
