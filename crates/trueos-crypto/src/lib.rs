...
//!
//! Apart from narrow standardized compatibility primitives such as TOTP, this
//! crate contains no cryptographic implementation, runtime service, filesystem
//! integration, or protocol adapter. Its public surface is the narrow seam
//! shared by future SSH and Ethereum layers:
//!
...
pub use totp::{
    TOTP_BASE32_BYTES, TOTP_DIGITS, TOTP_PERIOD_SECONDS, TOTP_SECRET_BYTES, TotpError,
    encode_totp_secret_base32, generate_totp_sha1, verify_totp_sha1,
};
