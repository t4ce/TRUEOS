...
pub enum EuArtifactKind {
    ...
    T8GroupidLive16Bf16DotThenHdc1StoreThenThreadSpawnerEot,
    T66Accum32HiLive96Bf16DotThenHdc1StoreThenThreadSpawnerEot,
    ...
    PrimaryScanoutGroupidLine1280RowsScalarBwThenHdc1StoreThenThreadSpawnerEot,
    PrimaryScanoutRow2560Simd16BwThenHdc1StoreThenThreadSpawnerEot,
    PrimaryScanoutRow2560Simd16XwalkerBwThenHdc1StoreThenThreadSpawnerEot,
    PrimaryScanoutRow2560Simd16OneStoreThenHdc1StoreThenThreadSpawnerEot,
    ...
    PrimaryScanoutMandelbrot16Simd16BwThenHdc1StoreThenThreadSpawnerEot,
}
