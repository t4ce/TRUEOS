...
pub const T62_ROW_INDEXED_LIVE16_STORE_SEND_DWORD: usize = 189;
...
//
// This is the first row-indexed partial matvec artifact.  Each workgroup uses
// `gl_WorkGroupID.x` as both the row selector inside the tile record and the
// output slot selector, then computes a live16 packed-BF16 partial dot.
// The userland oracle verified 8 workgroups writing 8 distinct output slots.
pub static T62_ROW_INDEXED_LIVE16_TRUEOS_ARENA_BF16_DOT_HDC1_STATELESS_STORE_THEN_TS_EOT_WORDS:
    ...
    0x00000000, 0x00000000, 0x00034231, 0x00000000, 0xCC02340C, 0x009A350C, 0x80030061, 0x7F050220,
