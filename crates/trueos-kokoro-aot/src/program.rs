...
use crate::format::{
    ARENA_ALIGNMENT, ARTIFACT_SHA256_OFFSET, BINDING_RECORD_BYTES, HEADER_BYTES, LITTLE_ENDIAN_TAG,
    MAGIC, MODEL_SHA256_OFFSET, OP_FLAG_IN_PLACE, OP_RECORD_BYTES, OpCode, PHASE_COUNT,
    PHASE_FLAG_RUNTIME_SIZED, PHASE_RECORD_BYTES, SECTION_COUNT, SECTION_DIRECTORY_OFFSET,
    SECTION_ENTRY_BYTES, SHA256_BYTES, SLOT_RECORD_BYTES, SectionKind, TENSOR_RECORD_BYTES,
    UNRESOLVED_SLOT_BASE, VERSION, VOICES_SHA256_OFFSET, artifact_sha256, checked_align_up,
    hash_eq, is_zero, read_i64, read_u16, read_u32, read_u64,
};
use crate::tensor::{
