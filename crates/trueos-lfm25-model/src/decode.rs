...
//! sealed operation which must be present in the selected backend before a token may
...
///
/// This stores counters only; recurrent vectors and KV values remain backend-owned.
