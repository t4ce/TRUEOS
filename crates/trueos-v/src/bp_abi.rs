...
pub const DOBBY_UI4_POINTER_BUTTON_PRESS: u32 = 2;
pub const DOBBY_UI4_POINTER_BUTTON_RELEASE: u32 = 3;
pub const DOBBY_UI4_POINTER_BUTTON_SHIFT: u32 = 16;
pub const DOBBY_UI4_POINTER_ACTION_MASK: u32 = (1u32 << DOBBY_UI4_POINTER_BUTTON_SHIFT) - 1;
pub const DOBBY_UI4_POINTER_BUTTON_MASK: u32 = !DOBBY_UI4_POINTER_ACTION_MASK;
pub const DOBBY_UI4_POINTER_BUTTON_LEFT: u32 = 1;
pub const DOBBY_UI4_POINTER_BUTTON_RIGHT: u32 = 1 << 1;
pub const DOBBY_UI4_POINTER_BUTTON_MIDDLE: u32 = 1 << 2;
pub const DOBBY_UI4_POINTER_CLICK_COUNT_SHIFT: u32 = 2;
pub const DOBBY_UI4_POINTER_CLICK_COUNT_MASK: u32 = 0x0f << DOBBY_UI4_POINTER_CLICK_COUNT_SHIFT;
pub const DOBBY_UI4_POINTER_CLICK_DELAY_SHIFT: u32 = 6;
pub const DOBBY_UI4_POINTER_CLICK_DELAY_MASK: u32 = 0x3ff << DOBBY_UI4_POINTER_CLICK_DELAY_SHIFT;
pub const DOBBY_UI4_POINTER_CLICK_COUNT_DEFAULT: u32 = 1;
pub const DOBBY_UI4_POINTER_CLICK_COUNT_MAX: u32 = 10;
pub const DOBBY_UI4_POINTER_CLICK_DELAY_MIN_MS: u32 = 100;
pub const DOBBY_UI4_POINTER_CLICK_DELAY_MAX_MS: u32 = 1_000;
...
/// Opaque endpoint value used by a hidden child Blueprint to address the
/// parent that spawned it.  Nonzero endpoint handles are returned only to the
/// parent by `trueos_cabi_blueprint_child_spawn_v1`.
pub const BLUEPRINT_CHILD_PARENT_HANDLE: u64 = 0;
pub const BLUEPRINT_CHILD_STATUS_STARTING: i32 = 1;
pub const BLUEPRINT_CHILD_STATUS_RUNNING: i32 = 2;
pub const BLUEPRINT_CHILD_STATUS_STOPPING: i32 = 3;
pub const BLUEPRINT_CHILD_STATUS_EXITED: i32 = 4;
pub const BLUEPRINT_CHILD_ERR_INVALID: i32 = -1;
pub const BLUEPRINT_CHILD_ERR_NOT_FOUND: i32 = -2;
pub const BLUEPRINT_CHILD_ERR_QUEUE_FULL: i32 = -3;
pub const BLUEPRINT_CHILD_ERR_UNAVAILABLE: i32 = -4;
...
unsafe extern "C" {
    ...
    /// kernel-owned and is bound to the active frame lease.
    ...
    pub fn trueos_cabi_ui4_scene_frame_primary_activation(window_id: u32, enabled: u32) -> i32;
    ...
    /// Arc in per-mille of a full half-short-side radius; 0=rect, 1000=circle for square frames.
    pub fn trueos_cabi_ui4_scene_frame_set_arc(window_id: u32, arc: u32) -> i32;
    ...
    pub fn trueos_cabi_vgpu_retained_frame_submit_v2(
        device: u64,
        queue: u64,
    ...
    pub fn trueos_cabi_vgpu_retained_frame_submit_v4(
        device: u64,
        queue: u64,
        submit: *const crate::vgpu::RetainedFrameSubmitV4,
        out_point: *mut crate::vgpu::TimelinePoint,
    ) -> i32;
...
/// Versioned USB-MIDI note edge exported to Blueprint-owned synthesis.
#[repr(C)]
#[derive(Copy, Clone, Debug, Default)]
