...
# For this dense, BSRAM-heavy topology use the vendor's routability-priority
# placer and congestion-aware router.  The speed-priority placer/router pair
# can finish its first routing phase and then make no further progress.
PLACE_OPTION="${TRUEGA_PLACE_OPTION:-1}"
