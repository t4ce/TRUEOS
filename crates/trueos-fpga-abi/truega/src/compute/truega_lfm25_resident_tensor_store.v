        ...
        if (!reset_n) begin
            ...
            if (session_begin_i) begin
                ...
                if (q30_write_valid_i && q30_write_ready_o) begin
                    ...
                    q30_slot_valid[q30_write_slot_i] <= 1'b1;
                    q30_slot_epoch[q30_write_slot_i] <= session_epoch_o;
                end
                if (q8_write_valid_i && q8_write_ready_o) begin
                    q8_memory[q8_write_address] <= q8_write_data_i;
                    q8_slot_valid[q8_write_slot_i] <= 1'b1;
                    q8_slot_epoch[q8_write_slot_i] <= session_epoch_o;
                end
