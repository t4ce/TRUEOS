...
static BROWSER_INPUT_STATE: Mutex<BrowserInputState> = Mutex::new(BrowserInputState {
    active_cursor: 1,
    cursors: Vec::new(),
});
...
#[inline]
fn get_or_create_cursor(state: &mut BrowserInputState, cursor_id: u32) -> &mut CursorInputState {
...
#[inline]
fn find_cursor(state: &BrowserInputState, cursor_id: u32) -> Option<&CursorInputState> {
    state.cursors.iter().find(|c| c.id == cursor_id)
}

unsafe extern "C" fn qjs_browser_input_set_active_cursor(
    ctx: *mut qjs::JSContext,
    ...
    let mut st = BROWSER_INPUT_STATE.lock();
    st.active_cursor = cursor;
    let _ = get_or_create_cursor(&mut st, cursor);
    qjs::JSValue::undefined()
}

unsafe extern "C" fn qjs_browser_input_get_active_cursor(
    _ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    _argc: i32,
    _argv: *const qjs::JSValueConst,
) -> qjs::JSValue {
    let st = BROWSER_INPUT_STATE.lock();
    js_int32(st.active_cursor as i32)
}

unsafe extern "C" fn qjs_browser_input_route_pointer_move(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_route_pointer_down(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_route_pointer_up(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_open_context_menu(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_close_context_menu(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
    ...
    let cursor_id = if args.is_empty() {
        BROWSER_INPUT_STATE.lock().active_cursor
    } else {
        unsafe { js_get_u32_or(ctx, args[0], 1) }.max(1)
    };
...
unsafe extern "C" fn qjs_browser_input_is_context_menu_open(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_context_menu_x(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_context_menu_y(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_context_menu_target(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_focused_target(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_hovered_target(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_set_clipboard_text(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_clipboard_text(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_clear_clipboard(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_cursor_x(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
unsafe extern "C" fn qjs_browser_input_get_cursor_y(
    ctx: *mut qjs::JSContext,
    _this_val: qjs::JSValueConst,
    argc: i32,
    argv: *const qjs::JSValueConst,
...
pub unsafe fn try_create_native_module(
    ...
    if name != b"trueos:browser_input" {
        return core::ptr::null_mut();
    }

    unsafe extern "C" fn qjs_browser_input_module_init(
        ctx: *mut qjs::JSContext,
        ...
        export_fn!("setActiveCursor", qjs_browser_input_set_active_cursor, 1);
        export_fn!("getActiveCursor", qjs_browser_input_get_active_cursor, 0);
        export_fn!("routePointerMove", qjs_browser_input_route_pointer_move, 4);
        export_fn!("routePointerDown", qjs_browser_input_route_pointer_down, 4);
        export_fn!("routePointerUp", qjs_browser_input_route_pointer_up, 4);
        export_fn!("openContextMenu", qjs_browser_input_open_context_menu, 4);
        export_fn!("closeContextMenu", qjs_browser_input_close_context_menu, 1);
        export_fn!("isContextMenuOpen", qjs_browser_input_is_context_menu_open, 1);
        export_fn!("getContextMenuX", qjs_browser_input_get_context_menu_x, 1);
        export_fn!("getContextMenuY", qjs_browser_input_get_context_menu_y, 1);
        export_fn!(
            "getContextMenuTarget",
            qjs_browser_input_get_context_menu_target,
            1
        );
        export_fn!("getFocusedTarget", qjs_browser_input_get_focused_target, 1);
        export_fn!("getHoveredTarget", qjs_browser_input_get_hovered_target, 1);
        export_fn!("setClipboardText", qjs_browser_input_set_clipboard_text, 2);
        export_fn!("getClipboardText", qjs_browser_input_get_clipboard_text, 1);
        export_fn!("clearClipboard", qjs_browser_input_clear_clipboard, 1);
        export_fn!("getCursorX", qjs_browser_input_get_cursor_x, 1);
        export_fn!("getCursorY", qjs_browser_input_get_cursor_y, 1);
        0
    }

    let m = unsafe { qjs::JS_NewCModule(ctx, module_name, Some(qjs_browser_input_module_init)) };
    if m.is_null() {
        return core::ptr::null_mut();
    }
