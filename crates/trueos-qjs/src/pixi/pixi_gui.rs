...
fn init_script_jsdelivr() -> &'static [u8] {
		br#"import * as PIXI from 'https://cdn.jsdelivr.net/npm/pixi.js@7.4.3/+esm';
...
var frameX = 96;
var frameY = 72;
var frameW = Math.max(200, W - 160);
var frameH = Math.max(160, H - 128);
...
var UI = {
	...
	setActive: function(idx) {
		...
		drawPixelText(nameGfx, spec.name, frameX, frameY - 28, 2, 0x202020);
	},
	start: function() {
...
fn init_script_esmsh() -> &'static [u8] {
		br#"import * as PIXI from 'https://esm.sh/pixi.js@7.4.3';
var G = (typeof globalThis !== 'undefined') ? globalThis : this;
var W = Number((G.window && G.window.innerWidth) || 1280);
var H = Number((G.window && G.window.innerHeight) || 800);
...
fn init_script_unpkg() -> &'static [u8] {
		br#"import * as PIXI from 'https://unpkg.com/pixi.js@7.4.3/dist/pixi.mjs';
var G = (typeof globalThis !== 'undefined') ? globalThis : this;
var W = Number((G.window && G.window.innerWidth) || 1280);
var H = Number((G.window && G.window.innerHeight) || 800);
