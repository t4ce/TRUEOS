...
export function makeNeonOrbSvg(opts = {}) {
  const ring = Number.isFinite(opts.ring) ? opts.ring : 34;
  const core = Number.isFinite(opts.core) ? opts.core : 14;
  const hueA = typeof opts.hueA === 'string' ? opts.hueA : '#00e5ff';
  const hueB = typeof opts.hueB === 'string' ? opts.hueB : '#ff2bd6';
