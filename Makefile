...
QEMU_USBMICE1_HOSTBUS ?= 1
QEMU_USBMICE1_HOSTADDR ?= 3
QEMU_USBMICE2_HOSTBUS ?= 1
QEMU_USBMICE2_HOSTADDR ?= 4
...
QEMU_USB_HOST_FLAGS = -device qemu-xhci,id=xhci,p2=8,p3=8,bus=pcie.0,addr=0x5  \
	...
	-device usb-mouse,bus=xhci.0,port=6,id=usbmice \
	-device usb-mouse,bus=xhci.0,port=7,id=usbmice2 \
