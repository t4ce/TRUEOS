...
const BUILTIN_CMD_REGISTRY: &[BuiltinShell2CmdEntry] = &[
    ...
    BuiltinShell2CmdEntry {
        ...
        tool_description: Some(
            "Launch the C++/IGC UI4 demos, including the live PCM audiovisual instrument, or select Spirit's 9x16 visual suite.",
        ),
