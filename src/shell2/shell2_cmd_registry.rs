...
const TOOL_JSON_GRID: &str = r#"{"type":"object","properties":{"instance":{"type":"string","description":"Optional instance name. Omit to claim the single shared default slot; name it to run several grids at once."}},"required":[],"additionalProperties":false}"#;
