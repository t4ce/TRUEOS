...
const TOOL_JSON_HELIO: &str = r#"{"type":"object","properties":{"action":{"type":"string","enum":["start","list","status"],"description":"Launch, list, or inspect embedded Helio examples."},"id":{"type":"integer","minimum":1,"maximum":4,"description":"Example id; 1 is simple-cube, 2 is churn-benchmark, and 3-4 are reserved."}},"required":[],"additionalProperties":false}"#;
...
const BUILTIN_CMD_REGISTRY: &[BuiltinShell2CmdEntry] = &[
    ...
    BuiltinShell2CmdEntry {
        ...
        tool_description: Some(
            "Launch numbered build-produced Helio examples through Render/GuC and UI4, or inspect their state.",
        ),
