...
mod tests {
    ...
    fn cpp_tool_schema_advertises_font_rush_start_and_stop() {
        ...
        assert!(command_registry_json().contains("exclusive Unicode glyph rush"));
    }
}
