...
fn print_tessel(io: &'static dyn ShellBackend2) {
    ...
    match crate::graphics::font::font_tessellated_scratch_triangle() {
        Some(triangle) => {
            ...
            print_shell_line(
                io,
                "font-tessel-render-font-field-vf-vue-isolate: source=first-triangle upload_vertices=3 path=vf-synthesized-vue goal=clip-acceptance",
            );
            ...
            print_shell_line(
                io,
                "font-tessel-render-font-field-vf-vue-two: source=first-two-triangles upload_vertices=6 upload_triangles=2 path=vf-synthesized-vue goal=clip-acceptance",
            );
            ...
            print_shell_line(
                io,
                format!(
                    "font-tessel-render-font-field-vf-vue-all: source=full-field upload_vertices={} upload_triangles={} path=vf-synthesized-vue goal=clip-acceptance",
                    isolated_all.len(),
                    isolated_all.len() / 3,
                )
                .as_str(),
    ...
    print_shell_line(
        io,
        format!(
            "font-tessel-clip-acceptance: one={} route_one={} two={} route_two={} all={} route_all={} big={} route_big={} all_counts={} gate={}",
    ...
    print_shell_line(
        io,
        format!(
            "font-tessel-final-candidate: one={} route_one={} two={} route_two={} all={} route_all={} big={} route_big={} all_counts={} gate={} markers=ps_state+raster_packet+clip_counter+no_ps",
    ...
    print_shell_line(
        io,
        format!(
            "font-tessel-gate: clip={} final_candidate={} next={}",
            all_clip_counts_ready as u8,
            all_candidate_counts_ready as u8,
    ...
    print_shell_line(
        io,
        format!(
            "font-tessel-verdict: clip_field_isolate={} clip_field_isolate_two={} clip_field_all={} vf_vue_isolate={} vf_vue_two={} vf_vue_all={} clip_counter_sweep={} clip_counter_vf_vue={} sweep=one:screen-space-default,two:clip-normal,all:clip-sf-sync,vf-vue:one/two/all/big,clip-counter:known-vs-big-inbounds completed={} ps_state_marker={} raster_packet={} clip_counter={} ps_observed={} fragment_candidate={} fragment_observed={} pixel_coverage=not-proven next={}",
    ...
    print_shell_line(
        io,
        "font-tessel-boundary: input=graphics-font-outline-cache output=mirrored-clip-field-isolate-all+vf-vue-one/two/all+big-inbounds-known-vs+big-inbounds-vf-vue intel=rcs-marker+3d-pipe-marker+clip-field-screen-space-default+clip-field-two-clip-normal+clip-field-all-clip-sf-sync+clip-counter-sweep raster_pixels=scratch-observational production-path=unchanged",
    );
}
