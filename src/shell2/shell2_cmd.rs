...
use super::{ShellBackend2, output_target_for_backend, print_shell_line, print_targeted_line};
...
async fn update_command_task(target_mask: u8, disk: crate::disc::block::DeviceHandle) {
    async move {
        ...
        let log = |line: &str| {
            print_targeted_line(target_mask, line);
        };
