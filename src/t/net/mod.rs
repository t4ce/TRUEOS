...
pub async fn fetch_html_best_effort_shared(
    ...
    crate::log_trace!("t/net: {} shared-tokio html begin url={}\n", job, url.as_str());
    match crate::t::run_on_shared_tokio(move || crate::r::net::html::fetch_html_best_effort(url))
        .await
    {
        Ok(result) => result,
        Err(_) => {
            crate::log_trace!("t/net: {} shared tokio runtime unavailable\n", job);
