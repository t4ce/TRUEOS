...
pub(crate) const HTML_SHACK_IDLE_LOGS: bool = true;
pub(crate) const GFX_FRAME_PROGRESS_LOGS: bool = true;
pub(crate) const INTEL_STAGE1_LOGS: bool = true;

pub(crate) const VIRGL_DRAW_DIAGNOSTICS_LOGS: bool = true;
...
pub(crate) const INTEL_CURSOR_PROBE_LOGS: bool = true;
...
pub(crate) const GFX_CABI_FRAME_DEBUG_LOGS: bool = true;
...
pub(crate) const USB_VENDOR_LOG_LEVEL: LevelFilter = LevelFilter::Trace;
...
pub(crate) const LUMEN_STORAGE_TRACE_LOGS: bool = true;
