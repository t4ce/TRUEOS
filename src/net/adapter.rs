...
pub struct TcpQuietHandoff {
    ...
    pub remote_win_scale: u8,
    pub remote_has_sack: u8,
    pub remote_mss: u16,
    pub last_remote_tsval: u32,
}

impl TcpQuietHandoff {
...
const CHECKED_UDP_SEND_RESULTS_CAP: usize = crate::allcaps::net::CHECKED_UDP_SEND_RESULTS_CAP;
        ...
        match cmd {
            ...
            NetCommand::OpenTcpConnect { remote } => {
                ...
                if is_ipv4_loopback(remote.addr)
                    || self
                        .local_ipv4
                        .is_some_and(|addr| addr.octets() == remote.addr)
                {
