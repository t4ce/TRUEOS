...
fn resolve_known_import(name: &str) -> Option<usize> {
    ...
    match name {
        ...
        "sinhf" => Some(trueos_math::sinhf as *const () as usize),
        "coshf" => Some(trueos_math::coshf as *const () as usize),
        "asinhf" => Some(trueos_math::asinhf as *const () as usize),
        "acoshf" => Some(trueos_math::acoshf as *const () as usize),
        ...
        "log1pf" => Some(trueos_math::log1pf as *const () as usize),
        "expf" => Some(trueos_math::expf as *const () as usize),
        "exp2f" => Some(trueos_math::exp2f as *const () as usize),
        ...
        "exp2" => Some(trueos_math::exp2 as *const () as usize),
        ...
        "trueos_cabi_wls_current_slot" => {
            Some(crate::wls::trueos_cabi_wls_current_slot as *const () as usize)
        }
...
fn resolve_runtime_abi_import(name: &str) -> Option<usize> {
    ...
    match name {
        ...
        "trueos_vlayer_usb_snapshot_read" => {
            Some(crate::r::net::vlayer::trueos_vlayer_usb_snapshot_read as *const () as usize)
        }
        ...
        "trueos_service_lane_cancellation_requested" => {
            Some(crate::r::blocking::trueos_service_lane_cancellation_requested as *const () as usize)
        }
