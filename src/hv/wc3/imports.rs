...
pub(crate) fn patch(
    ...
    for import in imports {
        ...
        } else if is_load_string_a(import) {
            super::thunk32::Kind::LoadStringA
...
pub(crate) fn is_load_string_a(import: &LauncherImport) -> bool {
    import.module.eq_ignore_ascii_case("USER32.dll") && import.symbol == "LoadStringA"
}
