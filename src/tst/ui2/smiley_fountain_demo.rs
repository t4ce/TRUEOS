...
const UI2_SMILEY_FOUNTAIN_TEX_ID: u32 = crate::tst::ui2::ids::Ui2DemoTexId::SmileyFountain.get();
...
const UI2_SMILEY_FOUNTAIN_MAX: usize = 60;
const UI2_SMILEY_FOUNTAIN_FRAME_MS: u64 = 100;
