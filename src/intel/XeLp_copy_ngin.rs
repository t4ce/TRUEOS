...
pub(crate) const COPY_SMOKE_PRE_COPY_SLOT: u64 =
    COPY_SMOKE_START_SLOT + COPY_SMOKE_RESULT_SLOT_BYTES;
pub(crate) const COPY_SMOKE_POST_COPY_SLOT: u64 =
    COPY_SMOKE_PRE_COPY_SLOT + COPY_SMOKE_RESULT_SLOT_BYTES;
pub(crate) const COPY_SMOKE_DONE_SLOT: u64 =
    COPY_SMOKE_POST_COPY_SLOT + COPY_SMOKE_RESULT_SLOT_BYTES;
...
pub(crate) fn build_mi_copy_smoke_batch(
    ...
    if !addr_aligned_4(copy_smoke_result_addr(plan.result_gpu_addr, COPY_SMOKE_PRE_COPY_SLOT)) {
        return Err(CopySmokeBuildError::UnalignedAddress {
            field: "result_gpu_addr+pre_copy",
            addr: copy_smoke_result_addr(plan.result_gpu_addr, COPY_SMOKE_PRE_COPY_SLOT),
        });
    }
    if !addr_aligned_4(copy_smoke_result_addr(plan.result_gpu_addr, COPY_SMOKE_POST_COPY_SLOT)) {
        return Err(CopySmokeBuildError::UnalignedAddress {
            field: "result_gpu_addr+post_copy",
            addr: copy_smoke_result_addr(plan.result_gpu_addr, COPY_SMOKE_POST_COPY_SLOT),
        });
    }
    if !addr_aligned_4(copy_smoke_result_addr(plan.result_gpu_addr, COPY_SMOKE_DONE_SLOT)) {
        return Err(CopySmokeBuildError::UnalignedAddress {
