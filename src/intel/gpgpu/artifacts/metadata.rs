...
pub(crate) const UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_ARTIFACT: GpgpuKernelArtifact =
    GpgpuKernelArtifact::contracted(
        UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_KERNEL_NAME,
        UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_BIN,
        UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_SPV,
        &UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_CPP_ABI_CONTRACT,
    );
