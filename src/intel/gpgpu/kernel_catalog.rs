...
const _: () = assert!(LAB256_MULTIPHASE_ADLS_BIN.len() == 53_304);
const _: () = assert!(LAB256_MULTIPHASE_ADLS_SPV.len() == 29_560);
...
pub(crate) const LAB256_MULTIPHASE_ADLS_BIN_SHA256: [u8; 32] = [
    0xBC, 0x8A, 0xA5, 0x50, 0xF9, 0x89, 0x9C, 0x98, 0xE7, 0xAF, 0x5C, 0x00, 0x59, 0xBB, 0x66, 0xFE,
    0x63, 0xB2, 0x2D, 0xD5, 0xE3, 0x46, 0x5A, 0x3C, 0xF2, 0x33, 0x95, 0xA1, 0x1B, 0x5F, 0x06, 0xE0,
];
