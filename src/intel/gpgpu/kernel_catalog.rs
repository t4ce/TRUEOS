...
const _: () = assert!(LAB256_MULTIPHASE_ADLS_BIN.len() == 61_360);
const _: () = assert!(LAB256_MULTIPHASE_ADLS_SPV.len() == 35_440);
...
pub(crate) const LAB256_MULTIPHASE_ADLS_BIN_SHA256: [u8; 32] = [
    0x37, 0x3C, 0x39, 0x71, 0x3F, 0x0F, 0x89, 0xF9, 0x8D, 0x66, 0x77, 0x3D, 0x31, 0x9F, 0x8E, 0x15,
    0x91, 0xCD, 0xEE, 0xE0, 0x7D, 0x06, 0xBF, 0xE4, 0x29, 0x44, 0x9E, 0x49, 0x55, 0xFC, 0x21, 0x2D,
];
