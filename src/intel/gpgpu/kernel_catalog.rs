...
const _: () = assert!(LAB256_MULTIPHASE_ADLS_BIN.len() == 60_680);
const _: () = assert!(LAB256_MULTIPHASE_ADLS_SPV.len() == 33_608);
...
pub(crate) const LAB256_MULTIPHASE_ADLS_BIN_SHA256: [u8; 32] = [
    0x90, 0xC7, 0xC8, 0x61, 0x13, 0xF5, 0x57, 0x21, 0xD3, 0x7B, 0x67, 0xDC, 0x69, 0xB8, 0x6D, 0x1A,
    0xFA, 0xD0, 0x96, 0xCC, 0x9E, 0xC6, 0x8E, 0x94, 0x68, 0x0D, 0xF0, 0x55, 0xC3, 0x2D, 0x76, 0x3F,
];
