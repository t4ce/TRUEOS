...
const _: () = assert!(LAB256_MULTIPHASE_ADLS_BIN.len() == 57_496);
const _: () = assert!(LAB256_MULTIPHASE_ADLS_SPV.len() == 31_892);
...
pub(crate) const LAB256_MULTIPHASE_ADLS_BIN_SHA256: [u8; 32] = [
    0xAA, 0x7A, 0x55, 0x7E, 0xC6, 0xE8, 0x83, 0x41, 0x95, 0xD7, 0xA3, 0xEB, 0xB8, 0x48, 0x4F, 0xC5,
    0xBB, 0xC0, 0xC8, 0x57, 0x55, 0xF9, 0xD8, 0x49, 0x6A, 0x3A, 0x70, 0xD1, 0xF1, 0xCA, 0xC7, 0xCF,
];
