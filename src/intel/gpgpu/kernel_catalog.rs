...
const _: () = assert!(SPIRIT_VFX_BACKGROUND_RGBA8_ADLS_BIN.len() == 48_056);
const _: () = assert!(SPIRIT_VFX_BACKGROUND_RGBA8_ADLS_SPV.len() == 17_220);
const _: () = assert!(SPIRIT_VFX_SPRITE_RGBA8_ADLS_BIN.len() == 73_728);
const _: () = assert!(SPIRIT_VFX_SPRITE_RGBA8_ADLS_SPV.len() == 22_736);
...
pub(crate) const SPIRIT_VFX_BACKGROUND_RGBA8_ADLS_BIN_SHA256: [u8; 32] = [
    0xD2, 0x1A, 0x1E, 0xA6, 0x2F, 0x9A, 0xB6, 0xF1, 0xC8, 0x69, 0xFF, 0xD3, 0x5D, 0x1A, 0x59, 0x89,
    0x88, 0xAC, 0xC6, 0x90, 0x5C, 0xAB, 0xBE, 0x16, 0x3E, 0x4C, 0x20, 0x82, 0x18, 0x8F, 0x05, 0x48,
];
pub(crate) const SPIRIT_VFX_SPRITE_RGBA8_ADLS_BIN_SHA256: [u8; 32] = [
    0x7B, 0xAA, 0x6B, 0x36, 0x13, 0xD9, 0x65, 0x6E, 0xA1, 0x92, 0x0F, 0x3E, 0xB4, 0xE2, 0x8E, 0xEB,
    0xA8, 0x8D, 0x93, 0x9F, 0x54, 0xE0, 0xF6, 0xFB, 0xC7, 0x37, 0x3F, 0xF1, 0x63, 0x71, 0x0B, 0x33,
];
