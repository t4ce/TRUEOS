...
const _: () = assert!(LAB256_MULTIPHASE_ADLS_BIN.len() == 63_120);
const _: () = assert!(LAB256_MULTIPHASE_ADLS_SPV.len() == 36_620);
...
pub(crate) const LAB256_MULTIPHASE_ADLS_BIN_SHA256: [u8; 32] = [
    0xB7, 0x76, 0x8C, 0x1B, 0x53, 0xB1, 0x95, 0xFF, 0x4C, 0xD3, 0x88, 0x6A, 0xC4, 0xF9, 0xE0, 0x41,
    0x5D, 0x92, 0x52, 0x7F, 0x08, 0x9A, 0x1C, 0xBC, 0x76, 0xD2, 0xA0, 0xCB, 0x47, 0x01, 0xC4, 0xD6,
];
