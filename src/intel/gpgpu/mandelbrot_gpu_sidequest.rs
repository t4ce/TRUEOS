    ...
    if !run_legacy_row_writer {
            ...
            && (mandelbrot16_probe_readback_ok || mandelbrot16_probe_finished)
        {
            ...
            loop {
                ...
                crate::log!(
                    "mandelbrot-gpu-sidequest: stage-ready-t30-fullscreen-redraw heartbeat={} reason=simd16-t30-promoted-t39-wide-stamp-address-color artifact_stage=simd16-t30-t39-wide-stamp-address-color-primary-plane color_mode=eu-address-derived-block-constant runtime_control=draw-same-frame-again redraw_same_frame={} control_version={} frame_seed=0x{:08X} target={}x{} row_cursor_enabled={} draw_row={} fallback_row={} fallback_x={} next_row_cursor={} rows_per_submit={} bands_per_heartbeat={} immediate_x_blocks_per_heartbeat={} immediate_lane_phases_per_block={} immediate_lane0_enabled={} submitted={} finished={} readback_ok={} sample_gpu=0x{:X} sample_before=0x{:08X} sample_after=0x{:08X} sample_expected=0x{:08X} sample_match={} lane_dispatch_delta={} finish_marker=0x{:08X} groupid_diagnostic_enabled={} groupid_submitted={} groupid_finished={} groupid_readback_ok={} groupid_sample_match={} active_t39_wide_stamp_address_color={} active_finished={} active_sample_match={} next=raise-rows-per-heartbeat-or-prove-gpu-side-groupid-xy proves=t30-runtime-loop-uses-t39-wide-stamp-address-color-contract does_not_prove=smooth-mandelbrot-coloring-or-gpu-side-coordinate-generation\n",
                    frame,
