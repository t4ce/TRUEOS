...
fn direct_rcs_encode_ui4_rgba8_to_nv12_linear_batch(
    state: DirectRcsState,
    upload: UploadedKernelArtifact,
    ...
    if !direct_rcs_write_interface_descriptor_at(
        ...
        params.dst_gpu,
        destination_bytes,
    ) || !direct_rcs_write_ui4_rgba8_to_nv12_payload_at(
        state,
        UI4_NV12_PRIMARY_PAYLOAD_OFFSET_BYTES,
        params,
    ) {
...
fn direct_rcs_encode_ui4_compose_layers_to_nv12_linear_batch(
    state: DirectRcsState,
    upload: UploadedKernelArtifact,
    ...
    if params.logical_width == 0
        || params.logical_height == 0
        || params.dst_width == 0
        || params.dst_height == 0
        || UI4_NV12_PRIMARY_PAYLOAD_OFFSET_BYTES + UI4_COMPOSE_LAYERS_TO_NV12_INDIRECT_BYTES
            > DIRECT_RCS_BATCH_BYTES
    {
        return false;
    }
    ...
    if !direct_rcs_write_interface_descriptor_at(
        ...
        UI4_NV12_PRIMARY_IDD_OFFSET_BYTES,
        UI4_NV12_PRIMARY_BINDING_TABLE_OFFSET_BYTES,
        UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_TEXT_OFFSET_BYTES,
        2,
        UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_GRFS,
    ) || !direct_rcs_write_copy_rect_surface_states_at(
        state,
        UI4_NV12_PRIMARY_BINDING_TABLE_OFFSET_BYTES,
        UI4_NV12_PRIMARY_SRC_SURFACE_STATE_OFFSET_BYTES,
        ...
        params.dst_gpu,
        destination_bytes,
    ) || !direct_rcs_write_ui4_compose_layers_to_nv12_payload_at(
        state,
        UI4_NV12_PRIMARY_PAYLOAD_OFFSET_BYTES,
        params,
    ) {
    ...
    ok &= direct_rcs_push_gpgpu_walker_2d(
        ...
        &mut cursor,
        UI4_NV12_PRIMARY_PAYLOAD_OFFSET_BYTES,
        UI4_COMPOSE_LAYERS_TO_NV12_INDIRECT_BYTES,
        params.dst_width.div_ceil(32),
        params.dst_height.div_ceil(2),
        GPGPU_WALKER_SIMD16_MASK,
    );
