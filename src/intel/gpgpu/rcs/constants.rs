...
// Chroma's two complete presets and sampler need a 192 KiB instruction window.
// The assertions below keep its full Zebin disjoint from both neighbors.
const SHADERTOY_MANDELBOX_ADLS_GPU: u64 = 0x0DF9_0000;
const SHADERTOY_PROTEAN_CLOUDS_ADLS_GPU: u64 = 0x0DE8_0000;
const SHADERTOY_PALETTE_GRID_ADLS_GPU: u64 = 0x0DF8_0000;
const SUBSET_SUM_COLLAPSE5_MERGE10_ADLS_GPU: u64 = 0x0DF0_0000;
const SHADERTOY_COSMIC_STRANDS_ADLS_GPU: u64 = 0x0DFC_0000;
const _: () = {
    assert!(
    ...
    assert!(
        SHADERTOY_PROTEAN_CLOUDS_ADLS_GPU + ((SHADERTOY_PROTEAN_CLOUDS_PACKAGE.bin_bytes as u64 + 4095) & !4095)
...
const SHADERTOY_MANDELBOX_TEXT_OFFSET_BYTES: u64 = SHADERTOY_MANDELBOX_ADLS_CPP_ABI_CONTRACT.entry_offset;
const SHADERTOY_PALETTE_GRID_TEXT_OFFSET_BYTES: u64 =
    SHADERTOY_PALETTE_GRID_ADLS_CPP_ABI_CONTRACT.entry_offset;
const SHADERTOY_COSMIC_STRANDS_TEXT_OFFSET_BYTES: u64 =
    SHADERTOY_COSMIC_STRANDS_ADLS_CPP_ABI_CONTRACT.entry_offset;
const SHADERTOY_PROTEAN_CLOUDS_TEXT_OFFSET_BYTES: u64 =
    SHADERTOY_PROTEAN_CLOUDS_ADLS_CPP_ABI_CONTRACT.entry_offset;
...
const SHADERTOY_SOURCE_SURFACE_STATE_OFFSET_BYTES: usize = 0x7D00;
const SHADERTOY_PAYLOAD_OFFSET_BYTES: usize = 0x7E00;
const SHADERTOY_UNIFORMS_OFFSET_BYTES: usize = 0x7F00;
const SHADERTOY_UNIFORMS_BYTES: usize = 24 * core::mem::size_of::<f32>();
...
const _: () = {
    ...
    assert!(
        SUBSET_SUM_PROBE_PAYLOAD_BASE_OFFSET_BYTES + 3 * SUBSET_SUM_PROBE_PAYLOAD_STRIDE_BYTES
            <= DIRECT_RCS_BATCH_BYTES
    );
    assert!(
        SUBSET_SUM_PROBE_PAYLOAD_BASE_OFFSET_BYTES
...
const _: () = {
    assert!(SHADERTOY_PALETTE_GRID_ADLS_GPU + ((SHADERTOY_PALETTE_GRID_PACKAGE.bin_bytes as u64 + 4095) & !4095) <= SHADERTOY_MANDELBOX_ADLS_GPU);
    assert!(SHADERTOY_MANDELBOX_ADLS_GPU + ((SHADERTOY_MANDELBOX_PACKAGE.bin_bytes as u64 + 4095) & !4095) <= SHADERTOY_COSMIC_STRANDS_ADLS_GPU);
};
