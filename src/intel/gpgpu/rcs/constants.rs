...
const UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_GPU: u64 = 0x0D90_0000;
...
const _: () = {
    ...
    assert!(
        UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_GPU
            + ((UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_BIN.len() as u64 + 4095) & !4095)
...
const UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_TEXT_OFFSET_BYTES: u64 =
    UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_CPP_ABI_CONTRACT.entry_offset;
...
const UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_BYTES: usize =
    UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_CPP_ABI_CONTRACT.cross_thread_data_bytes as usize;
const UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_GRFS: u32 =
    (UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_BYTES / 32) as u32;
const UI4_COMPOSE_LAYERS_TO_NV12_PER_THREAD_BYTES: usize =
    UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_CPP_ABI_CONTRACT.per_thread_data_bytes as usize;
const UI4_COMPOSE_LAYERS_TO_NV12_INDIRECT_BYTES: usize =
    UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_BYTES
        + UI4_COMPOSE_LAYERS_TO_NV12_PER_THREAD_BYTES;
const _: () = {
    assert!(matches!(
        UI4_COMPOSE_LAYERS_TO_NV12_LINEAR_ADLS_CPP_ABI_CONTRACT.validate(),
        Ok(())
    ));
    assert!(UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_BYTES == 128);
    assert!(UI4_COMPOSE_LAYERS_TO_NV12_CROSS_THREAD_GRFS == 4);
    assert!(UI4_COMPOSE_LAYERS_TO_NV12_PER_THREAD_BYTES == 96);
};
const _: () = assert!(
...
const UI4_COMPOSE_LAYERS_MAX_LAYERS: usize =
    SPRITE_QUAD_WORKLIST_DESC_BYTES / core::mem::size_of::<GpgpuUi4ComposeLayerDesc>();
