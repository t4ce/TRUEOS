...
const LFM25_Q8_PROJECT_TEXT_OFFSET_BYTES: u64 =
    LFM25_Q8_PROJECT_ADLS_CPP_ABI_CONTRACT.entry_offset;
...
const LFM25_Q8_IDD_OFFSET_BYTES: usize = 0x7000;
const LFM25_Q8_BINDING_TABLE_OFFSET_BYTES: usize = 0x7040;
const LFM25_Q8_WEIGHTS_SURFACE_STATE_OFFSET_BYTES: usize = 0x7080;
const LFM25_Q8_ACTIVATION_SURFACE_STATE_OFFSET_BYTES: usize = 0x70C0;
const LFM25_Q8_OUTPUT_SURFACE_STATE_OFFSET_BYTES: usize = 0x7100;
const LFM25_Q8_PAYLOAD_OFFSET_BYTES: usize = 0x7200;
...
const LFM25_Q8_INDIRECT_BYTES: usize =
    LFM25_Q8_CROSS_THREAD_BYTES + LFM25_Q8_PER_THREAD_BYTES;
...
const _: () = {
    assert!(LFM25_Q8_IDD_OFFSET_BYTES + LFM25_Q8_IDD_BYTES <= LFM25_Q8_BINDING_TABLE_OFFSET_BYTES);
    assert!(
    ...
    assert!(LFM25_Q8_PAYLOAD_OFFSET_BYTES + LFM25_Q8_INDIRECT_BYTES <= DIRECT_RCS_BATCH_BYTES);
    ...
    assert!(
        LFM25_Q8_OUTPUT_GPU + LFM25_Q8_OUTPUT_ALLOC_BYTES as u64
