...
const RESOLVE_TILE64_MSAA4_RGBA8_TEXT_OFFSET_BYTES: u64 =
    RESOLVE_TILE64_MSAA4_RGBA8_ADLS_CPP_ABI_CONTRACT.entry_offset;
...
const _: () = assert!(
    SCENE_AABB_ADLS_GPU + SCENE_AABB_ADLS_BIN.len() as u64 <= UI4_RGBA8_TO_NV12_LINEAR_ADLS_GPU
);
const _: () = assert!(
