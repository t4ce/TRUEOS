...
// Draw3D maps the currently acquired linear UI4 back buffer at this stable
// render VA. The physical mapping alternates with the frame-pool lease while
// the previous completed buffer remains owned by display.
