...
fn pixel_shader_dispatch_contract(
    ...
    let requested_dispatch = match backend_probe_mode {
...
mod pixel_shader_dispatch_contract_tests {
    ...
    #[test]
    fn mesa_like_simd16_is_one_kernel_in_ksp0() {
        assert_eq!(
    ...
    #[test]
    fn standalone_ps_simd16_probe_also_uses_ksp0() {
