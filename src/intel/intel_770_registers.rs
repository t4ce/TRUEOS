...
pub const INTEL_770_ENGINE_WAKE_REGISTERS: &[Intel770Register] = &[
    ...
    Intel770Register {
        block: "FORCEWAKE",
        name: "FORCEWAKE_ACK_VDBOX0",
        offset: 0x00D50,
        description: "VDBox0 media-slice wake acknowledge register",
        flags: FORCEWAKE_MEDIA_ACK_FLAGS,
    },
    Intel770Register {
        block: "FORCEWAKE",
        name: "FORCEWAKE_ACK_VDBOX1",
        offset: 0x00D54,
        description: "VDBox1 media-slice wake acknowledge register",
        flags: FORCEWAKE_MEDIA_ACK_FLAGS,
    },
    Intel770Register {
        block: "FORCEWAKE",
        name: "FORCEWAKE_ACK_VDBOX2",
        offset: 0x00D58,
        description: "VDBox2 media-slice wake acknowledge register",
        flags: FORCEWAKE_MEDIA_ACK_FLAGS,
    },
    Intel770Register {
        block: "FORCEWAKE",
        name: "FORCEWAKE_ACK_VDBOX3",
        offset: 0x00D5C,
        description: "VDBox3 media-slice wake acknowledge register",
        flags: FORCEWAKE_MEDIA_ACK_FLAGS,
    },
    Intel770Register {
        block: "FORCEWAKE",
