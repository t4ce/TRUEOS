...
pub(crate) use matmul::{
    ...
    stage_gpgpu_tile_record_output_rows_trusted, stage_gpgpu_tile_record_rows_probe,
    stage_gpgpu_tile_record_rows_trusted, submit_gpgpu_one_tile_output_compare_probe,
    submit_gpgpu_one_tile_output_sentinel_probe, submit_gpgpu_t5_one_row_matvec_probe,
    submit_gpgpu_t6_one_row_matvec_probe, submit_gpgpu_t8_batch2_rowblock_retire_probe,
