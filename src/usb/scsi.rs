// Minimal SCSI command-set helpers.
//
// This module is transport-agnostic: it only builds CDBs and parses responses.
// The transport (USB BOT, UAS, SAS, etc.) lives elsewhere.
