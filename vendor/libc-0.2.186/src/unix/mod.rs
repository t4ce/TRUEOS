...
cfg_if! {
    if #[cfg(not(all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu")))] {
        extern_ty! {
...
unsafe extern "C" {
    ...
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), not(target_env = "uclibc")),
    ...
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "arm"),
        link_name = "cfgetispeed@GLIBC_2.4"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "csky"),
        link_name = "cfgetispeed@GLIBC_2.29"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "m68k"),
    ...
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "powerpc"),
        link_name = "cfgetispeed@GLIBC_2.0"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "riscv32"),
        link_name = "cfgetispeed@GLIBC_2.33"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "sparc"),
        link_name = "cfgetispeed@GLIBC_2.0"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "x86"),
        link_name = "cfgetispeed@GLIBC_2.0"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "aarch64"),
        link_name = "cfgetispeed@GLIBC_2.17"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "loongarch64"),
    ...
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "riscv64"),
        link_name = "cfgetispeed@GLIBC_2.27"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "s390x"),
        link_name = "cfgetispeed@GLIBC_2.2"
    )]
    #[cfg_attr(
        all(any(target_os = "linux", target_os = "trueos"), target_env = "gnu", target_arch = "sparc64"),
        link_name = "cfgetispeed@GLIBC_2.2"
    )]
    #[cfg_attr(
        all(
