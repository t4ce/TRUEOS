...
fn decode_f32_bytes(data: &[u8], name: &str) -> Result<Vec<f32>, Box<dyn core::error::Error>> {
    if data.len() % 4 != 0 {
...
fn decode_f16_bytes(data: &[u8], name: &str) -> Result<Vec<f16>, Box<dyn core::error::Error>> {
    if data.len() % 2 != 0 {
...
fn decode_bf16_bytes(data: &[u8], name: &str) -> Result<Vec<bf16>, Box<dyn core::error::Error>> {
    if data.len() % 2 != 0 {
...
) -> Result<Vec<Entry>, Box<dyn core::error::Error>> {
