...
impl FloatCore for f32 {
    ...
    #[cfg(feature = "std")]
    forward! {
        core::primitive::f32::floor as floor(self) -> Self;
        core::primitive::f32::ceil as ceil(self) -> Self;
        core::primitive::f32::round as round(self) -> Self;
        core::primitive::f32::trunc as trunc(self) -> Self;
        core::primitive::f32::fract as fract(self) -> Self;
        core::primitive::f32::abs as abs(self) -> Self;
        core::primitive::f32::signum as signum(self) -> Self;
        core::primitive::f32::powi as powi(self, n: i32) -> Self;
    }
...
impl FloatCore for f64 {
    ...
    #[cfg(feature = "std")]
    forward! {
        core::primitive::f64::floor as floor(self) -> Self;
        core::primitive::f64::ceil as ceil(self) -> Self;
        core::primitive::f64::round as round(self) -> Self;
        core::primitive::f64::trunc as trunc(self) -> Self;
        core::primitive::f64::fract as fract(self) -> Self;
        core::primitive::f64::abs as abs(self) -> Self;
        core::primitive::f64::signum as signum(self) -> Self;
        core::primitive::f64::powi as powi(self, n: i32) -> Self;
    }
