...
mod test {
    ...
    fn test_insert() {
        ...
        // add one
        let insert1 =
            Record::from_rdata(name, 86400, RData::A(Ipv4Addr::new(93, 184, 216, 25).into()))
                .set_dns_class(DNSClass::IN)
                .clone();
    ...
    fn test_get_filter() {
        ...
        let name = Name::root();
        let rsasha256 =
            RRSIG::new(RecordType::A, Algorithm::RSASHA256, 0, 0, 0, 0, 0, Name::root(), vec![]);
        ...
        let ed25519 =
            RRSIG::new(RecordType::A, Algorithm::ED25519, 0, 0, 0, 0, 0, Name::root(), vec![]);

        let rrsig_rsa =
            Record::from_rdata(name.clone(), 3600, RData::DNSSEC(DNSSECRData::RRSIG(rsasha256)))
                .set_dns_class(DNSClass::IN)
                .clone();
        let rrsig_ecp256 =
            Record::from_rdata(name.clone(), 3600, RData::DNSSEC(DNSSECRData::RRSIG(ecp256)))
                .set_dns_class(DNSClass::IN)
                .clone();
        let rrsig_ecp384 =
            Record::from_rdata(name.clone(), 3600, RData::DNSSEC(DNSSECRData::RRSIG(ecp384)))
                .set_dns_class(DNSClass::IN)
                .clone();
        let rrsig_ed25519 =
            Record::from_rdata(name.clone(), 3600, RData::DNSSEC(DNSSECRData::RRSIG(ed25519)))
                .set_dns_class(DNSClass::IN)
                .clone();
