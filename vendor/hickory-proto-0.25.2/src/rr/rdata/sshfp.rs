...
mod tests {
    ...
    fn test_encode_decode_sshfp() {
        test_encode_decode(SSHFP::new(Algorithm::RSA, FingerprintType::SHA256, vec![]), &[1, 2]);
        test_encode_decode(
            SSHFP::new(Algorithm::ECDSA, FingerprintType::SHA1, vec![115, 115, 104, 102, 112]),
            &[3, 1, 115, 115, 104, 102, 112],
        );
        test_encode_decode(
            SSHFP::new(Algorithm::Reserved, FingerprintType::Reserved, b"ssh fingerprint".to_vec()),
            &[
