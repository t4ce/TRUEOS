...
impl f32x4 {
    ...
    pub fn sub_integer(&self, other: f32x4) -> f32x4 {
        Self::new(
            f32::from_bits(self.x0.to_bits() - other.x0.to_bits()),
            f32::from_bits(self.x1.to_bits() - other.x1.to_bits()),
            f32::from_bits(self.x2.to_bits() - other.x2.to_bits()),
            f32::from_bits(self.x3.to_bits() - other.x3.to_bits()),
        )
    }
