...
impl VideoMeshApp {
    pub fn new(
        ...
        let source_label = video_path
            .file_name()
            .and_then(|name| name.to_str())
            .unwrap_or("video")
            .to_owned();
        let (frames, stats) = video::spawn_decoder(video_path);
        render_state
            .renderer
            .write()
            .callback_resources
    ...
    fn controls(&mut self, ui: &mut egui::Ui) {
        ...
        ui.label(egui::RichText::new(&self.source_label).weak());
        ui.add_space(10.0);
    ...
    fn scene(&mut self, ui: &mut egui::Ui) {
        ...
        ui.painter()
            .rect_filled(rect, 0.0, egui::Color32::from_rgb(7, 10, 17));
