...
def check() -> None:
    ...
    require(launcher_source, "WINDOWS_XP_GET_VERSION: u32 = 0x0A28_0105", "XP GetVersion value")
    require(launcher_source, "DispatchOutcome::Resume", "GetVersion VM resume")
    require(launcher_source, "return #1 KERNEL32.dll!GetVersion", "GetVersion return trace")
    require(launcher_source, "HEAP_CREATE_RETURN: u32 = 0x0040_2D9B", "fixed HeapCreate return address")
    require(launcher_source, "HEAP_CREATE_INITIAL: u32 = 0x1000", "fixed HeapCreate initial size")
    require(launcher_source, "stack_words", "little-endian HeapCreate frame decoding")
    require(launcher_source, "GET_VERSION_EX_A_RETURN: u32 = 0x0040_2C61", "fixed GetVersionExA return address")
    ...
    require(thunks, "output[8] = 0xC3", "GetVersion RET thunk ending")
    require(thunks, "output[8] = 0x0F", "terminal thunk UD2 ending")
    require(thunks, "Kind::HeapCreate", "HeapCreate thunk kind")
    require(thunks, "output[8] = 0xC2", "HeapCreate RET 12 thunk ending")
