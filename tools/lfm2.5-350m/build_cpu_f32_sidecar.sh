...
GGUF="${TRUEGA_LFM25_GGUF:-$SCRIPT_DIR/LFM2.5-350M-Q8_0.gguf}"
OUTPUT="${TRUEGA_LFM25_F32_SIDECAR:-$SCRIPT_DIR/LFM2.5-350M-Q8_0.cpu-f32.bin}"
HOST_TOOLCHAIN="${TRUEGA_HOST_TOOLCHAIN:-1.96}"
HOST_TARGET="${TRUEGA_HOST_TARGET:-x86_64-unknown-linux-gnu}"
TARGET_DIR="${TRUEGA_LFM25_F32_TARGET_DIR:-/tmp/truega-lfm25-f32-target}"
